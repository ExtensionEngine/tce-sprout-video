(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('lodash/cloneDeep'), require('axios'), require('lodash/get'), require('lodash/isNil'), require('lodash/take')) :
  typeof define === 'function' && define.amd ? define(['exports', 'lodash/cloneDeep', 'axios', 'lodash/get', 'lodash/isNil', 'lodash/take'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.__TAILOR_CONTENT_ELEMENTS__ = global.__TAILOR_CONTENT_ELEMENTS__ || {}, global.__TAILOR_CONTENT_ELEMENTS__['tce-sprout-video'] = {}), global.cloneDeep, global.axios, global.get, global.isNil, global.take));
}(this, (function (exports, cloneDeep, axios, get, isNil, take) { 'use strict';
    ...
    computed: {
      isEmpty: function isEmpty() {
        var _this$element$data$vi = this.element.data.video,
            error = _this$element$data$vi.error,
            fileName = _this$element$data$vi.fileName;
        return !error && !fileName;
      },
      didUploadFail: function didUploadFail() {
        var status = this.element.data.video.status;
        return status === shared.ELEMENT_STATE.UPLOADING && !this.file;
      },
      errorMessage: function errorMessage() {
        var error = this.element.data.video.error;
        return this.didUploadFail ? UPLOAD_FAILED_ERROR_MSG : error;
      },
      infoMessage: function infoMessage() {
        var _this$element$data$vi2 = this.element.data.video,
  ...
  var __vue_render__$8 = function __vue_render__() {
    ...
    return _c('span', [!_vm.fileName ? _c('upload-btn', {
    ...
    }) : _vm._e(), _vm._v(" "), _vm.fileName ? _c('v-text-field', {
      attrs: {
        "value": _vm.fileName,
        "readonly": "",
        "hide-details": "",
      ...
      scopedSlots: _vm._u([{
        key: "prepend-inner",
        fn: function fn() {
          return [_c('v-icon', [_vm._v("mdi-closed-caption")])];
        },
        proxy: true
      }, {
        key: "append",
        fn: function fn() {
          return [_c('confirmation-dialog', {
            on: {
              "confirm": _vm.remove
            },
            scopedSlots: _vm._u([{
  ...
  var script$a = {
    ...
    computed: {
      ...
      generatedPosterFrames: function generatedPosterFrames(_ref2) {
        ...
        return take__default['default'](posterFrames, 4);
      },
  ...
  var __vue_render__$b = function __vue_render__() {
    ...
    return _c('span', [!_vm.video.fileName ? _c('upload-btn', {
      ...
      scopedSlots: _vm._u([{
        key: "prepend-inner",
        fn: function fn() {
          return [_c('v-icon', [_vm._v("mdi-video")])];
        },
        proxy: true
      }])
    })], 1);
  ...
  var __vue_scope_id__$b = "data-v-1dff3d34";
  /* module identifier */
  ...
  var __vue_render__$c = function __vue_render__() {
    ...
    }, [_vm._v("Sprout Video")]), _vm._v(" "), _c('v-toolbar-items', {
      staticClass: "mx-auto"
  ...
  var __vue_scope_id__$c = "data-v-302861b2";
  /* module identifier */
